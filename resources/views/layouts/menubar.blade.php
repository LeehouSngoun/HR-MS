    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="/position"><i class="fa fa-circle-o"></i> Positions</a></li>
            <li><a href="/department"><i class="fa fa-circle-o"></i> <span>Department</span></a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="/role"><i class="fa fa-shield"></i> <span>Role</span></a></li>
