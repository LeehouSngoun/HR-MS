...
Route::put('/edit_user/{id}', 'UserController@edit');
...
Route::get('/add_role', 'RoleController@insert');
Route::put('/edit_role/{id}', 'RoleController@edit');
Route::delete('/delete_role/{id}', 'RoleController@delete');
...
Route::get('/customlogout', 'CustomloginController@logout');